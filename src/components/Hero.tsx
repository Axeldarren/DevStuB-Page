...
const Hero = () => {
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute bottom-32 left-16 w-20 h-20 bg-accent/20 rounded-lg animate-pulse-slow" style={{ animationDelay: '2s' }}></div>
      <div className="absolute bottom-20 right-20 w-14 h-14 bg-warning/20 rounded-full animate-float" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto">
            Join a vibrant community of student developers. Learn, build, and grow together through coding, collaboration, and innovation.
          </p>
